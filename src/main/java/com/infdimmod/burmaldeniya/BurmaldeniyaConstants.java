...
public final class BurmaldeniyaConstants {
    ...
    public static final String DRUNNY_ATOM_BLOCK_ID = "drunny_atom";
    public static final String RESIDENT_ENTITY_ID = "resident";
    public static final String FOGI_ENTITY_ID = "fogi";
    public static final String DRUN_GUARD_ENTITY_ID = "drun_guard";
    public static final String DRUNNY_PARTICLE_ORBIT_ENTITY_ID = "drunny_particle_orbit";
    public static final String DORMITORY_STRUCTURE_ID = "dormitory";
    public static final String DRUNNY_COLLIDER_COMPLEX_STRUCTURE_ID = "drunny_collider_complex";
